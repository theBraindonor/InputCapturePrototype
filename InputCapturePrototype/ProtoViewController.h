...
@interface ProtoViewController : UIViewController<UITextViewDelegate> {
    UITextView *textView;
    UILabel *rfidLabel;
    UIButton *clearButton;
    
    NSMutableArray *rfidBuffer;
}

@property (nonatomic, retain) IBOutlet UITextView *textView;
@property (nonatomic, retain) IBOutlet UILabel *rfidLabel;
